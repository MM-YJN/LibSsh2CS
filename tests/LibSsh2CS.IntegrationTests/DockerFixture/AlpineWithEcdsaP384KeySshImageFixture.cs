...
// Marks AlpineWithEcdsaP384KeySshImageFixture as an assembly-wide fixture:
...
[assembly: AssemblyFixture(typeof(AlpineWithEcdsaP384KeySshImageFixture))]

namespace LibSsh2CS.IntegrationTests.DockerFixture;

/// <summary>
/// Assembly-wide fixture that builds the Alpine 3.20 image with the test
/// ECDSA-P384 public key (<c>Fixtures/ecdsa_p384_plain_key.pub</c>) installed
/// in <c>authorized_keys</c> on first use and retains it across
/// test runs. Used by the ECDSA-P384 publickey
...
/// </summary>
public sealed class AlpineWithEcdsaP384KeySshImageFixture(IMessageSink messageSink)
    : SshImageFixtureBase(messageSink)
{
    ...
    /// <summary>
    /// The test ECDSA-P384 public key, loaded from the embedded fixture
    /// resource at build time and baked into the image's
    /// <c>authorized_keys</c>.
    /// </summary>
    protected override string? AuthorizedKey => FixtureLoader.LoadText("ecdsa_p384_plain_key.pub");
}
